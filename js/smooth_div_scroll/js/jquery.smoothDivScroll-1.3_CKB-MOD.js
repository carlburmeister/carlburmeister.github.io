...
/* CKB
console.log('In smoothScrollRIGHT.js:: hotSpotScrollingInterval = ' + o.hotSpotScrollingInterval + 
			'el.data(scrollXPos) = ' + el.data("scrollXPos") +
			'scrollLeft(VALUE) = ' + (el.data("scrollWrapper").scrollLeft() + (el.data("scrollXPos") * el.data("speedBooster")))		
		);		
//*/	

						if (el.data("scrollXPos") > 0 && el.data("enabled")) {
							//el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() + (el.data("scrollXPos") * el.data("speedBooster")));
/* CKB - MODIFIED THIS LINE TO GET THE RIGHT SCROLLING TO BE constant speed*/  							
							el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() + 7 );
...
/* CKB				
console.log('In smoothScrollLEFT.js:: hotSpotScrollingInterval = ' + o.hotSpotScrollingInterval + 
			', el.data(scrollXPos) = ' + el.data("scrollXPos") +
			', scrollLeft(VALUE) = ' + (el.data("scrollWrapper").scrollLeft() - (el.data("scrollXPos") * el.data("speedBooster")))				
		);					
//*/	
						...
						if (el.data("scrollXPos") > 0 && el.data("enabled")) {
/* CKB - MODIFIED THIS LINE TO GET THE LEFT SCROLLING TO BE constant speed*/  							
							//el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() - (el.data("scrollXPos") * el.data("speedBooster")));
							el.data("scrollWrapper").scrollLeft(el.data("scrollWrapper").scrollLeft() - 7 );
